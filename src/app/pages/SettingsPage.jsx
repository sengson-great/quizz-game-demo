      ...
      <div className="space-y-5">
        ...
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4 }} className="rounded-2xl p-6" style={CARD}>
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-3">
            ...
            return (<button key={id} onClick={() => toggleCategory(id)} className="flex items-center gap-2 p-3 rounded-xl transition-all" style={{ background: isSelected ? 'rgba(232,76,106,0.06)' : 'rgba(0,0,0,0.02)', border: isSelected ? '1px solid rgba(232,76,106,0.2)' : '1px solid rgba(0,0,0,0.06)' }}>
