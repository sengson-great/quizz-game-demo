...
export default function LandingPage() {
    return (<div className="min-h-screen text-[#1A1A2E]" style={{ background: LIGHT_BG, fontFamily: 'Poppins, Inter, sans-serif' }}>
      ...
      <section className="relative z-10 px-4 py-20 max-w-4xl mx-auto">
        ...
        ].map(({ num, title, desc }, i) => (<motion.div key={num} initial={{ opacity: 0, x: -20 }} whileInView={{ opacity: 1, x: 0 }} viewport={{ once: true }} transition={{ delay: i * 0.1 }} className="flex gap-6 p-6 rounded-2xl" style={CARD_STYLE}>
