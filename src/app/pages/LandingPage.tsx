...
const FEATURES = [
  ...
  { icon: Swords, title: '1v1 Battle', desc: 'Go head-to-head against another player with real-time score tracking.', color: 'text-[#E84C6A]', gradient: 'from-[#E84C6A] to-pink-500' },
...
export default function LandingPage() {
  return (
    <div className="min-h-screen text-[#1A1A2E]" style={{ background: LIGHT_BG, fontFamily: 'Poppins, Inter, sans-serif' }}>
      {/* Ambient BG */}
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <div className="absolute -top-32 left-1/3 w-[700px] h-[700px] rounded-full opacity-[0.3]"
          style={{ background: 'radial-gradient(circle, #FCE4EC, transparent)', filter: 'blur(120px)' }} />
        <div className="absolute top-1/3 right-0 w-[500px] h-[500px] rounded-full opacity-[0.2]"
          style={{ background: 'radial-gradient(circle, #F8BBD0, transparent)', filter: 'blur(120px)' }} />
        <div className="absolute bottom-0 left-0 w-[400px] h-[400px] rounded-full opacity-[0.15]"
          style={{ background: 'radial-gradient(circle, #F48FB1, transparent)', filter: 'blur(100px)' }} />
      </div>
      ...
      <nav className="relative z-10 flex items-center justify-between px-6 py-5 max-w-7xl mx-auto">
        <div className="flex items-center gap-2.5">
          <div className="w-9 h-9 rounded-xl flex items-center justify-center shadow-lg"
            style={{ background: 'linear-gradient(135deg, #E84C6A, #F472B6)', boxShadow: '0 4px 15px rgba(232,76,106,0.3)' }}>
        ...
        <div className="flex items-center gap-4">
          <Link to="/leaderboard" className="text-slate-500 hover:text-[#1A1A2E] text-sm transition-colors">Leaderboard</Link>
          <Link to="/auth" className="px-5 py-2.5 rounded-xl text-white text-sm transition-all hover:shadow-lg hover:scale-[1.02]"
            style={{ background: 'linear-gradient(135deg, #E84C6A, #D43B59)', boxShadow: '0 2px 15px rgba(232,76,106,0.3)' }}>
            Get Started
          </Link>
        </div>
      </nav>
      ...
      <section className="relative z-10 text-center px-4 pt-16 pb-24 max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }}>
          ...
          <h1 className="text-[#1A1A2E] mb-6" style={{ fontFamily: 'Poppins, sans-serif', fontWeight: 800, fontSize: 'clamp(2.5rem, 7vw, 4.5rem)', lineHeight: 1.1 }}>
            Challenge Your<br />
            <span style={{ background: 'linear-gradient(135deg, #E84C6A, #F472B6, #c026d3)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent' }}>
              Knowledge
            </span>
          </h1>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/auth"
              ...
              style={{ background: 'linear-gradient(135deg, #E84C6A, #D43B59)', boxShadow: '0 4px 25px rgba(232,76,106,0.3)' }}>
              <Brain className="w-5 h-5" />
              Play Now
              <ChevronRight className="w-5 h-5 group-hover:translate-x-1 transition-transform" />
            </Link>
            <Link to="/leaderboard"
              className="flex items-center gap-2 px-8 py-4 rounded-2xl text-slate-600 transition-all hover:bg-white/60"
              style={{ border: '1px solid rgba(0,0,0,0.08)', background: 'rgba(255,255,255,0.6)' }}>
      ...
      <section className="relative z-10 px-4 py-20 max-w-6xl mx-auto">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          ...
          <p className="text-center text-slate-500 mb-12">Three game modes to match every mood</p>
      ...
      <section className="relative z-10 px-4 py-20 max-w-5xl mx-auto">
        <motion.div initial={{ opacity: 0 }} whileInView={{ opacity: 1 }} viewport={{ once: true }}>
          ...
          <p className="text-center text-slate-500 mb-12">Difficulty scales from Easy to Medium to Hard</p>
      ...
      <section className="relative z-10 px-4 py-20 text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }}>
          <div className="max-w-2xl mx-auto rounded-3xl p-12"
            style={{ background: 'rgba(232,76,106,0.06)', backdropFilter: 'blur(20px)', border: '1px solid rgba(232,76,106,0.12)', boxShadow: '0 4px 40px rgba(232,76,106,0.06)' }}>
            ...
            <p className="text-slate-500 mb-8">Join thousands of players competing in real-time quiz battles.</p>
            <Link to="/auth"
              className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl text-white transition-all hover:scale-[1.03]"
              style={{ background: 'linear-gradient(135deg, #E84C6A, #D43B59)', boxShadow: '0 4px 30px rgba(232,76,106,0.3)' }}>
              Start Playing Free
