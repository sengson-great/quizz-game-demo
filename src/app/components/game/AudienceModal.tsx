          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center"
                style={{ background: type === 'audience' ? 'rgba(232,76,106,0.1)' : 'rgba(52,211,153,0.1)' }}>
                  ...
                  <div key={answer.id} className="space-y-1">
                    ...
                    <div className="h-6 rounded-lg overflow-hidden" style={{ background: 'rgba(0,0,0,0.04)' }}>
                      <motion.div
                        ...
                        style={{ background: votes > 50 ? 'linear-gradient(90deg, #E84C6A, #F472B6)' : 'linear-gradient(90deg, #94a3b8, #cbd5e1)' }}
                      />
                    </div>
                  </div>
                );
