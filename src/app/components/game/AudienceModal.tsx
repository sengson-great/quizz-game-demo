      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between mb-6">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-xl flex items-center justify-center"
                style={{ background: type === 'audience' ? 'rgba(232,76,106,0.08)' : 'rgba(52,211,153,0.08)' }}>
              ...
              <div>
                ...
                <p className="text-[#9CA3AF] text-sm">{type === 'audience' ? 'Audience votes are in!' : 'Your friend says...'}</p>
              </div>
            </div>
            <button onClick={onClose} className="p-2 rounded-lg hover:bg-black/[0.03] text-[#9CA3AF] hover:text-[#1A1A2E] transition-colors">
              <X className="w-4 h-4" />
            </button>
          </div>
                  ...
                  <div key={answer.id} className="space-y-1">
                    ...
                    <div className="h-6 rounded-lg overflow-hidden" style={{ background: 'rgba(0,0,0,0.04)' }}>
                      <motion.div
                        ...
                        style={{ background: votes > 50 ? 'linear-gradient(90deg, #E84C6A, #F472B6)' : 'linear-gradient(90deg, #9CA3AF, #6B7280)' }}
                      />
                    </div>
                  </div>
                );
            ...
            <div className="rounded-xl p-4" style={{ background: 'rgba(52,211,153,0.04)', border: '1px solid rgba(52,211,153,0.12)' }}>
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-[#6B7280] text-sm leading-relaxed">{phoneMessage}</p>
                </div>
              </div>
            </div>
          )}
          ...
          <button
            ...
            style={{ background: 'linear-gradient(135deg, #E84C6A, #D63B5C)' }}
          >
            Got it!
          </button>
        </motion.div>
