                ...
                return (
                  <Link key={to} to={to}
                    className={`flex items-center gap-2 px-3.5 py-2 rounded-xl text-sm transition-all duration-200 ${
                      active
                        ? 'text-[#E84C6A]'
                        : 'text-[#6B7280] hover:text-[#1A1A2E] hover:bg-black/[0.03]'
                    }`}
            ...
            {currentUser ? (
              <>
                ...
                <button onClick={handleLogout}
                  className="p-2 rounded-xl text-[#9CA3AF] hover:text-red-500 hover:bg-red-50 transition-all duration-200">
              ...
              <Link to="/auth"
                ...
                style={{ background: 'linear-gradient(135deg, #E84C6A, #D63B5C)', boxShadow: '0 2px 10px rgba(232,76,106,0.35)' }}>
                Sign In
              </Link>
            )}
          </div>
              ...
              return (
                <Link key={to} to={to}
                  className={`flex items-center gap-1.5 px-3 py-1.5 rounded-xl text-xs whitespace-nowrap transition-all ${
                    active ? 'bg-[#E84C6A]/10 text-[#E84C6A]' : 'text-[#9CA3AF] hover:text-[#6B7280]'
                  }`}>
