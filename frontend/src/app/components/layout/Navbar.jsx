...
import { Trophy, LayoutDashboard, Settings, Shield, LogOut, Sparkles, Music, VolumeX } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto" style={{ paddingLeft: 'calc(0.75rem + var(--safe-area-left))', paddingRight: 'calc(0.75rem + var(--safe-area-right))' }}>
        <div className="flex items-center justify-between h-16">
          ...
          <div className="flex items-center gap-3">
            {/* Music mute button — only shown when music is playing */}
            {showMusicBtn && (
              <motion.button
                onClick={toggleMute}
              ...
              >
                {isMuted ? (
                  ...
                  >
                    <Music className="w-4 h-4 text-[#E84C6A]" />
                  </motion.div>
                )}
              </motion.button>
            )}
